...
} from "@/lib/reducers/destinationNotesReducer";
      ...
      <View style={tw`w-6/12 h-5/6 items-center bg-white rounded-lg p-4`}>
        ...
        <ScrollView style={tw`w-full`}>
          ...
          <View style={tw`w-full flex-row justify-between items-center`}>
            <TextInput
              style={tw`w-9/12 border border-dashed m-2 p-4 rounded-lg`}
            ...
            <Pressable
              ...
              style={tw`h-3/6 w-2/12 items-center justify-center bg-blue-500 rounded-full`}
            >
